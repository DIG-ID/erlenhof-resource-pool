...
Don't have an account?${" "} <a href="/register" class="underline underline-offset-4">Sign up</a> </div> </form> ` })} ` })} </div> ${renderScript($$result, "D:/apps/astro-app/src/components/RecoverForm.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/apps/astro-app/src/components/RecoverForm.astro", void 0);
...
}, "D:/apps/astro-app/src/pages/password-recovery.astro", void 0);

const $$file = "D:/apps/astro-app/src/pages/password-recovery.astro";
