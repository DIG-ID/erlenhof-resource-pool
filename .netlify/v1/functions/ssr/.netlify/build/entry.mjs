...
import { manifest } from './manifest_CCajCPRx.mjs';
...
const _page9 = () => import('./pages/api/friends/_id_.astro.mjs');
const _page10 = () => import('./pages/api/friends.astro.mjs');
const _page11 = () => import('./pages/api/jobs/apply.astro.mjs');
...
const _page23 = () => import('./pages/profile.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/friends/[id].ts", _page9],
    ["src/pages/api/friends/index.ts", _page10],
    ["src/pages/api/jobs/apply.ts", _page11],
    ...
    ["src/pages/profile.astro", _page23],
...
const _args = {
    "middlewareSecret": "3eae372a-c874-416d-981c-1dd250f51939"
};
